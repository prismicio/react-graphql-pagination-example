...
import { DefaultLayout, Header, AllPostsLoader } from '../components';
import NotFound from './NotFound';

/**
 * Blog homepage component that loads all posts
 */
const BlogHomeAllPosts = ({ location }) => {
...
export default withRouter(BlogHomeAllPosts);
