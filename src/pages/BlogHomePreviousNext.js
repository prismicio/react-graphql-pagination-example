...
import { DefaultLayout, Header, PreviousNextPagination } from '../components';
import NotFound from './NotFound';

/**
 * Blog homepage component with previous and next pagination
 */
const BlogHomePreviousNext = ({ location }) => {
...
export default withRouter(BlogHomePreviousNext);
